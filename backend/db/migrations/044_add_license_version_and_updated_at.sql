-- Migration 044: Agregar updated_at y license_version a licenses
-- 
-- Agrega columnas updated_at y license_version a la tabla licenses
-- Crea triggers para mantenerlas automaticamente
...
CREATE OR REPLACE FUNCTION increment_licenses_version()
RETURNS trigger AS $$ 
BEGIN
...
CREATE TRIGGER trg_licenses_version
    BEFORE UPDATE ON licenses
    FOR EACH ROW
    EXECUTE FUNCTION increment_licenses_version();
